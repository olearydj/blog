---
title: "TIL: Jupytext + MyST for MD ↔ Jupyter Notebooks"
author: "Dan O'Leary"
date: "2025-11-02"
...
Why MyST[^1]? It's markdown-native and explicitly distinguishes executable code cells (`{code-cell}`) from markdown code blocks, preventing AI confusion.
...
Use `+++` on its own line to force cell boundaries. I prefer to do this before and after all headers to put them in their own cell. This is because Jupyter's cell folding does not hide body text in the folded cell, just those under it.
...
Also, please apply the following rules, just because I like it this way:

- Use +++ BEFORE and AFTER ALL headers to put each in a separate cell
- Do NOT use **bold** formatting in list item descriptors
- Include a blank line before ALL bulleted/numbered lists and code blocks
```

This gives me clean, immediately-convertible markdown, and enforces some of my personal markdown styling preferences.
...
For this to work you'll need to have Jupytext installed in the same environment as Jupyter itself runs from. Pick your poison, `pip`, `conda`, or `uv` to update your venv accordingly.
